...
const Smallfooter = () => {
  ...
  return (
    <div>
      {/* ✅ Flex column on mobile, flex row on large screens */}
      <div className="flex flex-col lg:flex-row w-full  gap-[10px] items-center justify-center bg-[rgb(0,16,46)] p-[10px]">
        ...
        <div className="flex lg:w-[40%] gap-[20px] p-[20px] flex-col">
          ...
          <div className="flex flex-col gap-[15px] w-full max-w-[400px]">
            {[{ img: news1, state: dam, setState: setDam },
              ...
              { img: news3, state: enter, setState: setEnter }].map(({ img, state, setState }, i) => (
